...
import com.song.web.enums.Sql;
import com.song.web.mappers.SignMapper;
import com.song.web.mappers.TxMapper;
...
public class UserProxy extends Proxy{
	...
	public SignDTO makeUser() {
		return new SignDTO(makeUserid(), makeUsername(), "1", 
	...
	public void truncatePersons() {
		...
		signMapper.truncatePerson(box.get());
	}
